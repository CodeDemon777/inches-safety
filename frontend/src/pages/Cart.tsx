            ...
            {!checkoutMode ? (
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="space-y-3 mt-4">
                  <Button type="button" onClick={() => window.location.href = getUpiUrl()} className="w-full flex items-center justify-center gap-2 rounded-full bg-blue-600 text-white hover:bg-blue-700">
